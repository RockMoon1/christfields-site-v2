...
export default function VerseContextPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {/* Honest signpost to the deeper layer that is coming. */}
      <div className="mt-8 rounded-md border border-dashed border-border-sub bg-black-3/50 p-5">
        <p className="text-sm leading-relaxed text-silver">
          <span className="font-medium text-ivory">Coming soon:</span> tap any word to see its
          original Hebrew or Greek meaning, with the history behind it. Scripture stays the
          authority here; everything else is a lamp held up to it.
        </p>
      </div>
    </div>
  );
