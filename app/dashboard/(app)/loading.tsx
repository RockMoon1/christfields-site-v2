/**
 * Dashboard route group loading state. Next.js renders this instantly when
 * the user navigates between dashboard routes, while the new page's server
 * components fetch. Makes transitions feel snappy even when the database is
 * slow to respond.
 */
